...
void setup() { 
      ...
      // This Sketch supports WS2801 Protocol!
...
void loop() { 
  ...
  if (Serial.available())
  {
    ...
    /* Combine HI and LO byte to LED Count and set new COUNT if does not exceed maximum */
    ...
    if (irrecv.decode(&irresults)) {
      ...
      switch(uilastir)
      {
        ...
        case 0xFF48B7:  /* Pink-Light */
          bRed=255; bGreen=63; bBlue=195; bRedStep=8; bGreenStep=2; bBlueStep=8; 
          LEDS.showColor(CRGB(bRed, bGreen, bBlue));
          break;
